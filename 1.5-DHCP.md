...
и проверяем статус командой status. Если ошибки при неудачном запуске DHCP не было, systemctl status isc-dhcp-server. видим зеленую строку active (running), служба запущена.
