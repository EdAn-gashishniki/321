...
***
❗❗❗ ПЕРВЫЕ ШАГИ МОЖНО ПРОПУСТИТЬ ДО КОМАНДЫ `WGET`❗❗❗
***
...
После на HQ-CLI переходим по адресу HQ-SRV ( `http://192.168.100.2` ) и должен открыться `moodle`, выбираем язык установки Русский, жмём Далее
...
Изменяем строчку в конфигурации `config.php`

`nano /var/www/html/moodle/config.php`

![{9959305F-7F11-4769-90E6-A18B5B1C163D}](https://github.com/user-attachments/assets/5a86769b-524e-44c2-b0d5-4b0ff1b7ae62)
