...
Проверку DNS производим путём ввода команды `host` и имени устройства с доменом, обратную проверяем с вводом ip-адреса устройства.
